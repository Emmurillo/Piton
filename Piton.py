...
tokens = [
    ...
    'OPERADOR_INCLUSION','DEFINA','FIN_ARCHIVO', 'COMENTARIOS','OPERACION_MODULO','RANGO']
...
def p_regla_funciones(t):
    'sentencia : DEFINA VARIABLE PARENTESIS_IZQUIERDO lista_variables PARENTESIS_DERECHO INICIO_SEGMENTO lista_sentencias FIN_SEGMENTO'
    t[0] = t[4]

def p_regla_funciones2(t):
    'sentencia : DEFINA VARIABLE PARENTESIS_IZQUIERDO PARENTESIS_DERECHO INICIO_SEGMENTO lista_sentencias FIN_SEGMENTO'
    t[0] = t[2]

def p_regla_funciones3(t): 
    'sentencia : DEFINA VARIABLE PARENTESIS_IZQUIERDO PARENTESIS_DERECHO INICIO_SEGMENTO FIN_SEGMENTO'
    t[0] = t[2]
